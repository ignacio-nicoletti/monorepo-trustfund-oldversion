...
const warranties = pgTable(
  ...
  (table) => {
    return {
      ...
      inmobiliariaIdIdx: index("inmobiliaria_id_idx").on(table.inmobiliariaId),
      statusWarrantyIdIdx: index("status_warranty_id_idx").on(table.statusWarrantyId),
    };
  }
);

export default warranties;
export type InferWarranty = typeof warranties.$inferSelect;
