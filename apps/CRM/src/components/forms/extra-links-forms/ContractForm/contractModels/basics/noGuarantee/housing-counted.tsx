...
const HousingCounted: React.FC<FormData> = ({ nombreOrganizacion,
    nameApplicant,
    dni,
    contractType,
    cantQuotas,
    ...
    return (
        <div className='flex flex-col gap-4'>
           ...
           <h2 className='mx-auto font-medium w-3/4 text-center'>CONTRATO DE GARANTÍA PARA USO HABITACIONAL - ANEXO I – TÉRMINOS Y CONDICIONES</h2>
            <div>
                <p>
                    {nombreOrganizacion} como parte de {nombreOrganizacion === "Trust Fund" ? `${dataTrusFund.razonSocial}, CUIT ${dataTrusFund.CUIT}` : `${dataOkCred.razonSocial}, ${dataOkCred.CUIT}`},
                    representada por {nombreOrganizacion === "Trust Fund" ? `${dataTrusFund.representante.nombre}, DNI ${dataTrusFund.representante.DNI}`
                        : `${dataOkCred.representante.nombre},${dataOkCred.representante.DNI}`}.
            ...
            <div>
                <p>
                    <strong className='font-medium'>1.</strong> Que los intervinientes, acuerdan que el presente contrato resulta accesorio e integrativo al de locación,
            ...
            <div>
                <p>
                    <strong className='font-medium'>2. {nombreOrganizacion}</strong> se constituye frente al LOCADOR en FIADOR del LOCATARIO por las obligaciones que le resulten exigibles al mismo en virtud del contrato de locación suscripto y antes referido,
                    con las limitaciones y alcance que dispone el presente contrato de garantía.
                </p>
            </div>
            <div>
                <p>
                <strong className='font-medium'>3.</strong> Que el valor total de la garantía es de {currencyWarrantyAmount} {warrantyAmount} y el pago se establece en una primera cuota, equivalente al {percentageQuota}% del valor de la garantía en concepto de RESERVA y el saldo restante,
            ...
            <div>
                ...
                <p>
                    <strong className='font-medium'>4.</strong> La presente fianza accesoria tendrá vigencia a partir del momento de la suscripción del contrato de locación principal al que ella se anexa y su plazo de vigencia será,
                    ...
                    <span>
                        <br /> 
                        <strong className='font-medium'>A) {nombreOrganizacion} como parte de  {nombreOrganizacion === "Trust Fund" ? `${dataTrusFund.razonSocial}, CUIT ${dataTrusFund.CUIT}` : `${dataOkCred.razonSocial}, ${dataOkCred.CUIT}`}, constituyendo domicilio  {nombreOrganizacion === "Trust Fund" ? dataTrusFund.domicilio : dataOkCred.domicilio}</strong>, donde serán válidas todas las notificaciones que se le remitan y en los términos del CONTRATO DE GARANTÍA N° {numContract}- ANEXO I – TÉRMINOS Y CONDICIONES,
                        ...
                        <br /> 
                        <strong className='font-medium'> A.1)</strong> El LOCADOR, previa intimación fehaciente por mora  al LOCATARIO, deberá notificar vía correo electrónico los incumplimientos al FIADOR {nombreOrganizacion}, dentro de los 30 días corridos de acontecido cada vencimiento de pago respecto del Alquiler y Expensas Ordinarias bajo pena de imputarse la caducidad de la garantía frente a cada reclamo de periodo extemporáneo.
                        - Ante el segundo aviso consecutivo de incumplimiento de pago de canon locativo por parte del LOCATARIO, es que el LOCADOR deberá rescindir unilateralmente el contrato locativo y extender el mandato previsto en los términos del apartado.
                        <br /> 
                        <strong className='font-medium'> B)</strong>  de la presente cláusula, siendo ello condición esencial, bajo pena de quedar extinta la Fianza de pleno derecho, liberando totalmente al FIADOR.
                    ...
                    <span>
                       <strong className='font-semibold'>B)</strong> En los supuestos del punto 
                       <strong className='font-semibold'>A.1)</strong>de la presente cláusula y, frente al incumplimiento de pago del segundo canon locativo consecutivo por parte del LOCATARIO, es que el LOCADOR se obliga a notificar de ello, en forma directa y fehaciente a {nombreOrganizacion} dentro de los plazos allí enunciados y de acaecida la mora automática, a fin de que el FIADOR subsidiariamente abone los importes en los términos de la garantía.
            ...
            <div>
                <p>
                    <strong className='font-semibold'>5.</strong> Queda expresamente establecido que la Fianza comprende exclusivamente: <br />
                    ...
                    <br /> <br />
                    <span>
                    <strong className='font-semibold'>5.1</strong> El pago de las expensas ordinarias mensuales desde la celebración del contrato de locación hasta la restitución del inmueble locado.
            ...
            <div>
                <p>
                <strong className='font-semibold'>6.</strong> Conforme lo anterior se deja establecido que las restantes obligaciones <strong>SE ENCUENTRAN EXCLUIDAS</strong> de la presente Fianza.
                    - Los conceptos excluidos que se enumeran a continuación son citados a modo ejemplificativo y no taxativo:
                     <br/>
                    <span>
                    <strong className='font-semibold'>6.1</strong> Las cláusulas penales, intereses y multas establecidas en el contrato de locación y/o la normativa vigente, con excepción de lo acordado en los puntos 5.2, 5.3, 5.4 y 5.5 precedentes.
                    </span>
                    <br/>
                    <span>
                    <strong className='font-semibold'>6.2</strong> Las expensas extraordinarias y sus intereses de cualquier naturaleza con independencia de quien las hubiere asumido en el contrato de locación.
                    </span>
                    <br/>
                    <span>
                    <strong className='font-semibold'>6.3</strong>  Los daños y/o perjuicios y/o reparaciones que pudieren provocarse por hechos de caso fortuito y/o fuerza mayor y/o por los causados por la conducta del LOCATARIO y/o terceros, sean respecto del inmueble locado y/u otros bienes o personas, a excepción de lo señalado en el punto 5.3.
                    </span>
                    <br/>
                    <span>
                    <strong className='font-semibold'>6.4</strong> Los daños y/o deterioro y/o reparaciones necesarias del inmueble locado causado por el transcurso del tiempo, el uso o desgaste natural de las cosas.
                    </span>
                      <br/>
                    <span>
                    <strong className='font-semibold'>6.5</strong>  Los impuestos, tasas y contribuciones nacionales, provinciales y municipales que afecten al inmueble locado y/o el pago de servicios sobre el mismo, como así tampoco los impuestos necesarios para la habilitación municipal a excepción de los señalados en el punto 5.2.
                    </span>
                      <br/>
                    <span>
                    <strong className='font-semibold'>6.6</strong>  Los gastos, tasas y/o honorarios profesionales judiciales y/o extrajudiciales que fueren instados por el LOCADOR, el LOCATARIO y/o cualquier tercero que no sea {nombreOrganizacion}.
                    </span>
                      <br/>
                    <span>
                         <strong className='font-semibold'>6.7</strong> El pago de la tasa municipal SUM (Servicios Urbanos Municipales) y los servicios de agua corriente y/o electricidad, sus recargos y multas, cuyos importes están expresados por las facturas y/o informes de deuda, emitidos por las empresas prestadoras de los mismos, que correspondan al inmueble locado, hasta un monto máximo equivalente a (2) meses de alquiler. - Esta obligación podrá ser reclamada sólo en el caso que tal obligación hubiere sido asumida por el LOCATARIO en el contrato de locación.
                    </span>
                      <br/>
                    <span>
                      ...
                      <br/>
                    <span>
                         <strong className='font-semibold'>6.9</strong> El pago de los gastos que ocasionen y/o demanden, tanto judicial como extrajudicialmente, el eventual desalojo y/o desocupación del inmueble.
                    </span>
                </p>
            </div>
            <div>
                <p>
                <strong className='font-semibold'>7.</strong> El LOCADOR asume la obligación de notificar a {nombreOrganizacion}, por escrito y de modo fehaciente, de cualquier incumplimiento en que incurra el LOCATARIO que pueda comprometer la garantía de Fianza otorgada,
            ...
            <div>
                <p>
                <strong className='font-semibold'>8.</strong> TRUST FUND está obligado a abonar las obligaciones imputables al LOCATARIO que ha garantizado en favor del LOCADOR y que se encuentren incumplidas, de plazo vencido,
            ...
            <div>
                <p>
                <strong className='font-semibold'>9.</strong> El LOCATARIO declara y garantiza que cuenta con los fondos y recursos económicos suficientes para atender las obligaciones derivadas del contrato de locación suscripto y el presente contrato de Fianza.
                </p>
            </div>
           
            <div>
                <p>
                <strong className='font-semibold'>10.</strong> El LOCATARIO se obliga a dar aviso e información detallada a TRUST FUND, en el plazo de 48hs., de cualquier circunstancia, hecho o conflicto con el LOCADOR o terceros que pueda comprometer la Fianza otorgada.
            ...
            <div>
                <p>
                <strong className='font-semibold'>11.</strong> Queda expresamente establecido entre las partes que aun cuando el LOCATARIO cuestione su responsabilidad por incumplimientos contractuales alegados por el LOCADOR, en la hipótesis de reclamo del mismo contra TRUST FUND,
            ...
            <div>
                <p>
                <strong className='font-semibold'>12.</strong> Las partes de común acuerdo establecen y declaran que las obligaciones, contenidas en el contrato principal de locación de inmueble, son de carácter personal del LOCATARIO,
            ...
            <div>
                <p>
                <strong className='font-semibold'>13.</strong> La rescisión o resolución anticipada del contrato de locación principal, por cualquier causa que fuere, no otorga derecho alguno a reclamar la restitución de parte proporcional del precio pagado o a pagar por la fianza otorgada, siendo tal precio definitivo y no reembolsable, insusceptible de disminución o restitución.
                </p>
            </div>
            
            <div>
                <p>
                <strong className='font-semibold'>14.</strong> La Fianza otorgada se extingue conjuntamente con el contrato de locación principal y/o si se declare la nulidad de éste y/o si existiere simulación en la celebración del mismo y/o si el LOCADOR no tuviere poder o mandato suficiente de administración del inmueble.
                </p>
            </div>
          
            <div>
                <p>
                <strong className='font-semibold'>15.</strong> Si se verificase que la información presentada por el LOCATARIO y/o sus garantes respecto de sus actividades, bienes, datos personales o remuneraciones fuere falsa o inexacta, TRUST FUND tiene derecho a solicitar las sustituciones y/o ampliaciones que considere necesarias,
            ...
            <div>
                <p>
                <strong className='font-semibold'>16.</strong>  Los impuestos y tasas derivados del presente contrato serán pagados en exclusividad por el LOCATARIO afianzado.
                </p>
            </div>
      
            <div>
                <p>
                <strong className='font-semibold'>17.</strong> Las partes, de común acuerdo, manifiestan que, en caso de controversia o conflicto por el alcance o la interpretación de las estipulaciones del presente contrato, se someten a la jurisdicción de los Tribunales Ordinarios Civiles y Comerciales del Departamento Judicial de La Plata, Pcia. de Buenos Aires, renunciando a cualquier otro fuero y/o jurisdicción que les pudiere corresponder.
                </p>
            </div>
            <div className='border mt-4 p-2'>
                <p><strong>NOTIFICACIONES.</strong> Las partes constituyen los siguientes datos de contacto donde</p>
            </div>
            <div className='border mt-4 p-2 flex flex-col'>
                ...
                <p><strong>EL FIADOR: </strong>
                    Domicilio:{nombreOrganizacion === "Trust Fund" ? dataTrusFund.domicilio : dataOkCred.domicilio}.
                    Mail: {nombreOrganizacion === "Trust Fund" ? dataTrusFund.email : dataOkCred.email}</p>
                <div className='flex flex-col'>
                    <strong> EL INQUILINO / LOCATARIO:</strong>
                    <p>Domicilio:</p>
                    <p>Mail:</p>
                    <p>Teléfono:</p>
                </div>
